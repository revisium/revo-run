...
export const ConsensusParticipantWorkflowInputSchema = Type.Object(
  {
    runId: RunIdSchema,
...
export const ConsensusParticipantWorkflowArgumentsSchema = Type.Tuple([
  ConsensusParticipantWorkflowInputSchema,
]);

export type ConsensusParticipantWorkflowInput = DeepReadonly<
  Type.Static<typeof ConsensusParticipantWorkflowInputSchema>
>;
